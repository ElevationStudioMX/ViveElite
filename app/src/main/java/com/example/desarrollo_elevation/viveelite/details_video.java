...
*/
        ...
        // final int tiempo = (int)bundle.getDouble("yttiempo");
...
*/
        ...
        //textTiutulo.setText(/*"Ejercicio de calentamiento y cardio"*/title);
...

        {
            ...
            if(id_tipo_contenido == 1) {
               ...
               // textSubtitulo.setPadding(10,0,0,0);
...
*/
          ...
          /*  Log.v("datos ", "" + appLinkData + " " + appp);
            ...
            //toolbar.setTitle(/*"Ejercicio de calentamiento y cardio"*/title);

            getSupportActionBar().setTitle(/*"Muffins de Plàtano con Crema de Cacahuate"*/title);
            DBHome dbHome = new DBHome(this, name_database_elite, null, 1);

            final SQLiteDatabase database = dbHome.getWritableDatabase();


            //  String SQLforword = "select contenido.id_tipo from contenido where id ="+idlink+" and  ";
            ...
            //  final String vid = bundle.getString("ytvideo");
