...
public class MainActivity_detalle_producto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        else if(numero == 2)
        {
            ...
            list.add(new Model_productos(1, R.drawable.servilletas_elite_celeste, "ELITE CELESTE", "Servilletas de mesa con textura esponjosita de alto rendimiento, que brindan una excelente absorción y resistencia en toda ocación."));
        ...
        {
            list.add(new Model_productos(1, R.drawable.toalla_elite_color, "ELITE COLOR", "La combinación ideal entre funcionalidad y diseño, cuenta con un grabado super absorbente y figuras coloreadas que te brindan una agradable solución en las tareas de limpieza en tu cocina."));
